                            ...
                            <div id="test1">
                                <div class="sign ">
                                    <div class="form-group">
                                        <label class="form-label" for="email">Verification code: <span style="color:red">*</span></label>
                                        <div class="input-group input-group-merge">
                                            <input id="email" type="text" name="verify"
                                                   required="" class="form-control form-control-prepended" placeholder="Your verification code">
