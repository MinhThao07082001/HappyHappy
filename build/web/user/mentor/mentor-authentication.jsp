...
<html lang="en"
    ...
    <head>
        ...
        <title>Mentor Authentication</title>
                ...
                <div class="mdk-drawer-layout__content page ">
                    <div class="container-fluid page__container">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Mentor Authentication</li>
                        </ol>
                        <h1 class="h2">Mentor Authentication</h1>
                        <div class="card">
                            <ul class="nav nav-tabs nav-tabs-card">
                                <li class="nav-item">
                                    <a class="nav-link active"
                                       href="#first"
                                       data-toggle="tab">Authentication By Image</a>
                                </li>
                            </ul>
