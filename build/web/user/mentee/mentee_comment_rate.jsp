                    ...
                    <div class="mdk-drawer-layout__content page ">
                        ...
                        <div class="container-fluid page__container">
                            ...
                            <div class="text-center">
                                <a href="#"><img src="${pageContext.request.contextPath}/user/assets/images/people/110/guy-8.jpg"
                                                 alt=""
                                    ...
                                    <div class="card-header">
                                        <div class="media align-items-center">
                                            <div class="media-left">
                                                <a href="${pageContext.request.contextPath}/user/instructor-take-course.html">
                                            ...
                                            <div class="media-body">
                                                <h4 class="card-title mb-0"><a href="${pageContext.request.contextPath}/user/instructor-take-course.html">Learn VueJs</a></h4>
                                                <div class="rating">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h4 class="card-title mb-0"><a href="${pageContext.request.contextPath}/user/instructor-take-course.html">Npm &amp; Gulp Advanced Workflow</a></h4>
                                                <div class="rating">
                                                    <i class="material-icons">star</i>
                                                    <i class="material-icons">star</i>
                                                    <i class="material-icons">star</i>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h4 class="card-title mb-0"><a href="${pageContext.request.contextPath}/user/instructor-take-course.html">Github Webhooks for Beginners</a></h4>
                                                <div class="rating">
                                                    <i class="material-icons">star</i>
                                                    <i class="material-icons">star</i>
                                                    <i class="material-icons">star</i>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h4 class="card-title mb-0"><a href="${pageContext.request.contextPath}/user/instructor-take-course.html">Gulp &amp; Slush Workflows</a></h4>
                                                <div class="rating">
                                                    <i class="material-icons">star</i>
                                                    <i class="material-icons">star</i>
                                                    <i class="material-icons">star</i>
