...
<div class="mdk-header-layout js-mdk-header-layout">
        ...
        <div id="header" data-fixed class="mdk-header js-mdk-header mb-0">
            <div class="mdk-header__content">
                ...
                <!-- Navbar -->
                <nav id="default-navbar" class="navbar navbar-expand navbar-dark bg-primary m-0" style="background: #9eabe4; border-radius: 20px; background-image: linear-gradient(315deg, #9eabe4 0%, #77eed8 74%);">
                    <div class="container-fluid" >
                        ...
                        <!-- Brand -->
                        <a href="mentee-dashboard.jsp" class="navbar-brand">
