<%-- 
    ...
    Created on : Oct 20, 2021, 3:07:53 AM
    Author     : WacMac
--%>
...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            <li class="scroll-to-section ho"><a href="#welcome" class="menu-item">Home</a></li>
                            <li class="scroll-to-section ho "><a href="#about" class="menu-item">feature</a></li>
                            <li class="scroll-to-section ho"><a href="#about" class="menu-item">Service</a></li>
                            <li class="scroll-to-section ho"><a href="#contact-us" class="menu-item">FAQ</a></li>

                        </ul>
                        <li class="scroll-to-section re1">
                            <a href="../SignIn.jsp" class="menu-item"  >
                                <span> Sign In</span>
                            </a>
                        </li>
    ...
    <div class="welcome-area" id="welcome">
        ...
        <div class="header-text">
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-9 col-md-12 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        ...
                        <a href="#about" class="main-button-slider">Are you looking for tutor?</a>
