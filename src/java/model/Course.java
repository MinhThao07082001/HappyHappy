...
public class Course {
    ...
    public Course(int courseID, int subjectID,int mentorID, int slots, int timePerSlot, int moneyPerSlot, String timeStart, String timeEnd, int learnType, int status, String description, String createTime) {
